...
#' \code{\link{create_neural_network()}}. Very straightforwardly it is the
...
#'
#' @param nu A neural network of the type generated by
#' \code{\link{create_neural_network()}}.
#'
...
#'
#' @param nu A neural network of the type generated by
#' \code{\link{create_neural_network()}}. Denoted \eqn{\mathsf{L}}.
#'
...
#'
#' @param nu A neural network of the type generated by
#' \code{\link{create_neural_network()}}. Denoted \eqn{\mathsf{P}}.
#'
